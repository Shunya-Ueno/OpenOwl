...
// backend/supabase/functions/_shared/infrastructure/supabase/database.types.ts と同一内容。
// 再生成: cd backend && supabase gen types typescript --linked > ../frontend/src/shared/supabase/database.types.ts
